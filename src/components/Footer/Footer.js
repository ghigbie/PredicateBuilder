    ...
    return(
        <footer className="row footer">
            ...
            <div className="col-md-6 d-inline button-holder">
                ...
                <button className="btn btn-outline-secondary btn-sm float-right footer-button button-wide">Save Preset</button>
                <button className="btn btn-secondary btn-sm float-right footer-button">Export</button>
            </div>
        </footer>
    );
};
